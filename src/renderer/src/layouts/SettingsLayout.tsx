...
export function SettingsLayout(): React.ReactElement {
  ...
  const [showAdvanced, setShowAdvanced] = useState(() => {
    return localStorage.getItem('vb_show_advanced_settings') === 'true'
  })
          ...
          <div className="px-4 py-4 border-b border-[var(--ivory-border)]">
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0">
                ...
                <p className="text-[10px] text-[var(--ivory-text-3)] truncate font-body">Vibeforge workspace controls</p>
              </div>
            </div>
          </div>
