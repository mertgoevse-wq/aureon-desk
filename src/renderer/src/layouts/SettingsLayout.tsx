        ...
        >
          ...
          <div className="p-3 border-t border-[var(--ivory-border)]">
            <button
              type="button"
              onClick={() => navigate('/')}
              className="w-full h-9 rounded-2xl border border-[var(--ivory-border)] bg-[var(--ivory-bg)] text-[12px] font-semibold text-[var(--ivory-text-2)] hover:text-[var(--ivory-text)] hover:bg-[var(--ivory-surface-2)] transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--ivory-accent)]/35"
            >
              Back to Chat
            </button>
          </div>
