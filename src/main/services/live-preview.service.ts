...
<body>
  <div class="card">
    <h1>Vibeforge Preview</h1>
    <p>This is a live preview sandbox. Generated by Vibeforge.</p>
...
srv.listen(${port},'127.0.0.1',()=>{console.log('Vibeforge_PREVIEW_READY:'+${port});});
...
export const livePreviewService = {
  ...
  async startPreview(sandboxPath: string, port = 0): Promise<PreviewStatus> {
    ...
    const isDemo = fs.existsSync(path.join(sandboxPath, '.vibeforge-demo')) || fs.existsSync(path.join(sandboxPath, '.Vibeforge-demo'))
