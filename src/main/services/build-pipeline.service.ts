...
function classifyIntent(prompt: string): BuildIntentClassification {
  ...
  let suggestedName = 'Vibeforge App'
...
<body>
  <div class="app">
    <div class="card" style="max-width:440px;margin:0 auto;text-align:center">
      <h1>${appName}</h1>
      <p class="subtitle">Built with Vibeforge — Local Demo</p>
...
.counter.bump {
  ...
  const js = `// ${appName} — Generated by Vibeforge
...
<body>
  <div class="app" style="max-width:800px;margin:0 auto">
    <div class="card" style="text-align:center;padding:3rem 2rem">
      ...
      <h1>${appName}</h1>
      <p class="subtitle">A beautifully crafted web experience — built with Vibeforge.</p>
...
document.getElementById('btn-cta').addEventListener('click', function() {
  alert('Welcome to ${appName}!\\n\\nThis is a local demo generated by Vibeforge.');
});
...
- Include a footer "Generated by Vibeforge"
