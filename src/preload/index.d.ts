export interface IpcApi {
  ...
  systemPromptList: () => Promise<import('../shared/types/prompt').SystemPromptRow[]>
  ...
  systemPromptUpdate: (id: string, input: Partial<import('../shared/types/prompt').NewSystemPrompt>) => Promise<import('../shared/types/prompt').SystemPromptRow | undefined>
  systemPromptDelete: (id: string) => Promise<boolean>
  promptLibraryList: (filters?: { search?: string; tags?: string[]; category?: string }) => Promise<import('../shared/types/prompt').PromptRow[]>
