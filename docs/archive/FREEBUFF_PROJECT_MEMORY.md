# Vibeforge — Freebuff Project Memory
...
- **Home Page**: Time-aware greeting, Vibeforge SVG mark, centered composer card with model/project/system-prompt selectors, 8 suggestion chips, recent chats list
...
|---|-------|----------|----------|
| 1 | Vibeforge logo/top-left is too small (24px SVG in 48px container) | Medium | Sidebar.tsx, AppShell.tsx |
...
| Duplicate inline Vibeforge SVG mark | Rendered inline in Sidebar.tsx, AppShell.tsx, and ChatWorkspace.tsx |
...
- **Inline SVG Repetition**: Same Vibeforge mark SVG repeated in 3+ files
...
2. Fix Vibeforge logo size in sidebar and topbar (larger, more prominent)
...
7. Extract inline SVG mark into a shared `VibeforgeMark` component
